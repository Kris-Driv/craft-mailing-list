...
namespace krisdrivmailing\mailinglist\widgets;

use krisdrivmailing\mailinglist\MailingList;
use krisdrivmailing\mailinglist\assetbundles\constactcontactintegrationstatuswidget\ConstactContactIntegrationStatusWidgetAsset;
 ...
 * @since     1.0.0
 */
class ConstactContactIntegrationStatus extends Widget
{
    ...
    {
        return Craft::t('mailing-list', 'ConstactContactIntegrationStatus');
    }
    ...
    {
        return Craft::getAlias("@krisdrivmailing/mailinglist/assetbundles/constactcontactintegrationstatuswidget/dist/img/ConstactContactIntegrationStatus-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'mailing-list/_components/widgets/ConstactContactIntegrationStatus_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ConstactContactIntegrationStatusWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'mailing-list/_components/widgets/ConstactContactIntegrationStatus_body',
            [
